...
public class Program {
	...
	public static void main(String[] args) { //apagou o trows pq o programa não vai mais porpagar a exceção, 																	// propagar
                                             // vamos agora tratar a exceção e não propaga-la.    
